      ...
      <div className="relative" ref={drawerRef}>
        ...
        {isOpen && (
          <>
            ...
            />
            <div className="fixed inset-x-0 bottom-0 top-auto md:absolute md:top-full md:bottom-auto md:right-0 md:mt-2 w-full md:w-[340px] bg-white dark:bg-slate-800 rounded-t-3xl md:rounded-2xl border-t border-slate-200 md:border md:border-slate-200 dark:border-slate-700 shadow-2xl z-50 overflow-hidden flex flex-col max-h-[85vh] md:max-h-none">
              {/* Header */}
